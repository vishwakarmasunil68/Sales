...
public class Pref {
    ...
    private static final String PrefDB = "leads";
    private static final String PerPrefDB = "perleads";
    ...
    public static void SaveDeviceToken(Context context, String Value) {
        SharedPreferences sp = context.getSharedPreferences("leadsdevicetoken.txt", MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
